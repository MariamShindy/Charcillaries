...
{ 
	...
	[Serializable]
	[DataContract]
	public partial class PassengerFlightDetailsView
	{
		/// <summary>Gets or sets the Flight field. </summary>
		[DataMember]
		public PassengerFlightDetailsViewTypes.Flight Flight { get; set; }
		...
		[DataMember]
		public List<PassengerFlightDetailsViewTypes.PassengerAmenitySelection> PassengerAmenitySelections { get; set; }
		...
		[DataMember]
		public PassengerFlightDetailsViewTypes.Person Person { get; set; }
	}

	namespace PassengerFlightDetailsViewTypes
	{
		...
		namespace FlightTypes
		{
			...
			namespace FlightRouteTypes
			{
				...
				{
					/// <summary> DTO class which is derived from the entity 'Amenity (Flight.FlightRoute.RouteAmenities.Amenity)'.</summary>
					[Serializable]
					[DataContract]
			...
			/// <summary> DTO class which is derived from the entity 'TourOperator (Flight.TourOperator)'.</summary>
			[Serializable]
			[DataContract]
